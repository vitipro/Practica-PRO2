/** 
	@mainpage Práctica de PRO2. Codificación y decodificación de textos. Documentación. 
	...
	Este contiene un menú con diferentes opciones y operaciones para también obtener información de los diferentes idiomas y sus codificaciones.
*/
